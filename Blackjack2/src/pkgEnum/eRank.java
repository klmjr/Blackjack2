...
public enum eRank {
	...
	NINE(9,9,9), TEN(10,10,10), JACK(11,10,10), QUEEN(12,10,10), KING(
			13,10,10), ACE(14,11,1);
	...
	public void setiCardValueMin(int iCardValueMin) {
		this.iCardValueMin = iCardValueMin;
	}
	...
	public void setiCardValueMax(int iCardValueMax) {
		this.iCardValueMax = iCardValueMax;
	}
